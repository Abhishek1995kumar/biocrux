                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                            ...
                            <!-- <div class="menu-item">
                                <div class="menu-content">
                                    <span class="menu-heading fw-bold text-uppercase fs-7">GOPL Exclusive </span>
                                </div>
                            </div>
                            ...
                            <!-- Dashboard -->
                            <a href="{{url('/admin/dashboard')}}" class="menu-item menu-accordion">
                            ...
                            <div class="menu-item pt-5">
                                <div class="menu-content">
                                    <span class="menu-heading fw-bold text-uppercase fs-7">{{ Auth::user()->role }}</span>
                                </div>
                            </div>

                            <!-- Content -->
                            <!-- <a href="{{url('/admin/incineration')}}" class="menu-item menu-accordion">
                                <span class="menu-link {{Request::is('admin/incineration*') ? 'active' : ''}}">
                                    <span class="menu-icon">
                                        <span class="svg-icon svg-icon-2">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect x="2" y="2" width="9" height="9" rx="2" fill="currentColor" />
                            ...
                            <!-- <div data-kt-menu-trigger="click" class="menu-item {{Request::is('admin/requests*','admin/grievances*') ? 'here show' : ''}} menu-accordion">
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    <div class="menu-item">
                                        <a class="menu-link {{Request::is('admin/requests-and-grievances/requests*') ? 'active' : ''}} " href="{{url('/admin/requests-and-grievances/requests')}}">
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link {{Request::is('admin/requests-and-grievances/grievances*') ? 'active' : ''}} " href="{{url('/admin/requests-and-grievances/grievances')}}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    <div class="menu-item">
                                        <a class="menu-link {{Request::is('admin/requests-and-grievances/requests*') ? 'active' : ''}} " href="{{url('/admin/requests-and-grievances/requests')}}">
                                            ...
                                            <span class="menu-title">SMS Track Report</span>
                                        </a>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link {{Request::is('admin/requests-and-grievances/grievances*') ? 'active' : ''}} " href="{{url('/admin/requests-and-grievances/grievances')}}">
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link {{Request::is('admin/requests-and-grievances/grievances*') ? 'active' : ''}} " href="{{url('/admin/requests-and-grievances/grievances')}}">
                                            ...
                                            <span class="menu-title">Bin Alert</span>
                                        </a>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link {{Request::is('admin/requests-and-grievances/grievances*') ? 'active' : ''}} " href="{{url('/admin/requests-and-grievances/grievances')}}">
                                            ...
                                            <span class="menu-title">Customers Report</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- ABC Centers -->
                            <a href="{{url('/admin/abc-centers')}}" class="menu-item menu-accordion">
                                <span class="menu-link {{Request::is('admin/abc-centers*') ? 'active' : ''}}">
                                    <span class="menu-icon">
                                        <span class="svg-icon svg-icon-2">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect x="2" y="2" width="9" height="9" rx="2" fill="currentColor" />
                                    ...
                                    <span class="menu-title">System Errors</span>
                                </span>
                            </a>
                            ...
                            <a href="{{url('/admin/abc-centers')}}" class="menu-item menu-accordion">
                                <span class="menu-link {{Request::is('admin/abc-centers*') ? 'active' : ''}}">
                                    ...
                                    <span class="menu-title">Pending Points</span>
                                </span>
                            </a>
                            ...
                            <a href="{{url('/admin/abc-centers')}}" class="menu-item menu-accordion">
                                <span class="menu-link {{Request::is('admin/abc-centers*') ? 'active' : ''}}">
                                    ...
                                    <span class="menu-title">Redeem History</span>
                                </span>
                            </a>

                            <!-- Closure -->
                            <a href="{{url('/admin/closure')}}" class="menu-item menu-accordion">
                                <span class="menu-link {{Request::is('admin/closure*') ? 'active' : ''}}">
                                    <span class="menu-icon">
                                        <span class="svg-icon svg-icon-2">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect x="2" y="2" width="9" height="9" rx="2" fill="currentColor" />
                                    ...
                                    <span class="menu-title ">Machine Approval</span>
                                </span>
                            </a>

                            <!-- Release -->
                            <a href="{{url('/admin/release-requests')}}" class="menu-item menu-accordion">
                                <span class="menu-link {{Request::is('admin/release-requests*') ? 'active' : ''}}">
                                    <span class="menu-icon">
                                        <span class="svg-icon svg-icon-2">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect x="2" y="2" width="9" height="9" rx="2" fill="currentColor" />
                            ...
                            <!-- Field Vacination -->
                            <a href="{{url('/admin/field-vaccination')}}" class="menu-item menu-accordion">
                                <span class="menu-link {{Request::is('admin/field-vaccination*') ? 'active' : ''}}">
                                    <span class="menu-icon">
                                        <span class="svg-icon svg-icon-2">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect x="2" y="2" width="9" height="9" rx="2" fill="currentColor" />
                                    ...
                                    <span class="menu-title ">Machine Transaction</span>
                                </span>
                            </a>

                            <!-- Circulars -->
                            <a href="{{url('/admin/circulars')}}" class="menu-item menu-accordion">
                                <span class="menu-link {{Request::is('admin/circulars*') ? 'active' : ''}}">
                                    <span class="menu-icon">
                                        <span class="svg-icon svg-icon-2">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect x="2" y="2" width="9" height="9" rx="2" fill="currentColor" />
                                    ...
                                    <span class="menu-title"> User Transaction</span>
                                </span>
                            </a>
                            ...
                            <!-- User Management -->
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item {{Request::is('admin/requests*','admin/grievances*') ? 'here show' : ''}} menu-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link {{Request::is('admin/user/botler*') ? 'active' : ''}} " href="{{url('/admin/user/botler/list')}}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Botler Master</span>
                                            </a>
                                        </div>
                                        <!-- <div class="menu-item">
                                            <a class="menu-link {{Request::is('admin/user/sub-botler*') ? 'active' : ''}} " href="{{url('/admin/user/sub-botler/list')}}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Sub Botler Master</span>
                                            </a>
                                        </div> -->
                                        <!-- <div class="menu-item">
                                            <a class="menu-link {{Request::is('admin/user/botler/assign*') ? 'active' : ''}} " href="{{url('/admin/user/botler/assign')}}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Assign Machine to Bottler</span>
                                            </a>
                                        </div> -->
                                        <!-- <div class="menu-item">
                                            <a class="menu-link {{Request::is('admin/user/sub-botler/assign*') ? 'active' : ''}} " href="{{url('/admin/user/sub-botler/assign')}}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Assign Machine to Sub Bottler</span>
                                            </a>
                                        </div> -->
                                        <!-- <div class="menu-item">
                                            <a class="menu-link {{Request::is('admin/user/user*') ? 'active' : ''}} " href="{{url('/admin/user/user/list')}}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">User</span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{Request::is('admin/user/role*') ? 'active' : ''}} " href="{{url('/admin/user/role/list')}}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{Request::is('admin/user/permission*') ? 'active' : ''}} " href="{{url('/admin/user/permission/list')}}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                            ...
                            <!-- Machine Master -->
                                <div class="menu-item pt-5">
                                    <div class="menu-content">
                                        <span class="menu-heading fw-bold text-uppercase fs-7">Machine Management</span>
                                    </div>
                                </div>
                                <div data-kt-menu-trigger="click" class="menu-item {{Request::is('admin/master/machine*') ? 'here show' : ''}} menu-accordion">
                                    <span class="menu-link">
                                        <span class="menu-icon">
                                            <span class="svg-icon svg-icon-2">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link {{ Request::is('admin/master/machine*') ? 'active' : '' }} " href="{{ route('admin.master.machine.list') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link {{ Request::is('admin/master/validate-mobile*') ? 'active' : '' }} " href="{{ route('admin.master.validate-mobile.list') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Validate Mobile No Master</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link {{ Request::is('admin/master/sms*') ? 'active' : '' }} " href="{{ route('admin.master.sms.list') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Machine SMS</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link {{ Request::is('admin/master/qr-bin*') ? 'active' : '' }} " href="{{ route('admin.master.qr-bin.list') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">QR BIN</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <!-- Mobile App Management -->
                                <div class="menu-item pt-5">
                                    <div class="menu-content">
                                        <span class="menu-heading fw-bold text-uppercase fs-7">Mobile Management</span>
                                    </div>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link {{Request::is('admin/master/slider*') ? 'active' : ''}} " href="{{url('/admin/master/slider/list')}}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                            ...
                            <div class="menu-item">
                                <a class="menu-link {{Request::is('admin/master/bin*') ? 'active' : ''}} " href="{{url('/admin/master/bin/list')}}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Bin Master</span>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="post d-flex flex-column-fluid" id="kt_post">
                        <div class="loader-container" id="loaderContainer">
                            <svg class="loader_circle_1 mx-auto d-block" width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id="loader_1">
                                    <path id="Subtract" fill-rule="evenodd" clip-rule="evenodd" d="M8.7868 8.7868C3.35786 14.2157 0 21.7157 0 30C0 46.5685 13.4315 60 30 60C46.5685 60 60 46.5685 60 30C60 13.4315 46.5685 0 30 0V5.00001C30 5.00001 30.0001 5.00001 30.0001 5.00001C43.8072 5.00001 55.0001 16.1929 55.0001 30C55.0001 43.8071 43.8072 55 30.0001 55C16.193 55 5.00008 43.8071 5.00008 30C5.00008 23.0965 7.79829 16.8465 12.3224 12.3224L8.7868 8.7868Z" fill="#5598FF" />
                                </g>
                            </svg>
                        </div>
