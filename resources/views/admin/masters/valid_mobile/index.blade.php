...
@section('title','Validate Mobile List')
...
<div class="card">
    <div class="card-header border-0 pt-6" style="    justify-content: left !important;">
        ...
        <div class="card-title">
            <div class="d-flex align-items-center position-relative">
                <a href="{{ route('admin.master.validate-mobile.list') }}" class="btn btn-light p-3"><i class="fa fa-fw fa-refresh"></i>Refresh</a>
            </div>
        </div>
    </div>
    <div class="card-body">
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="leaderNameForm" action="{{ route('admin.master.validate-mobile.save') }}" method="POST" enctype="multipart/form-data">
...
<!-- Edit Valid Mobile Start -->
    <div class="modal fade modal-lg" id="editMobileModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog" aria-labelledby="addBotlerTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-md">
            <div class="modal-content">
                <input type="hidden" name="id" value="">
                <div class="modal-header">
...
<!-- View Valid Mobile Start -->
    <div class="modal fade modal-lg" id="viewMobileModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog" aria-labelledby="addBotlerTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-md">
            <div class="modal-content">
                <input type="hidden" name="id" value="">
                <div class="modal-header">
