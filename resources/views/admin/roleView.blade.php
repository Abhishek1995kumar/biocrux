                    ...
                    <tbody class="fw-semibold text-gray-600">
                        ...
                        <tr>
                            ...
                            <td class="d-flex align-items-center">
                                <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                    <div class="symbol-label">
                                        <img src="{{$data->profileImage != null ? $data->profileImage : 'assets/media/blank.png'}}" alt="" class="w-100" />
                                    </div>
                                </div>
                            ...
                            <td class="text-center">
                                <a href="{{url('/admin/user/update?user='.Crypt::encrypt($data->id).'&tab=general')}}" class="btn btn-icon btn-active-light-primary w-30px h-30px me-3">
