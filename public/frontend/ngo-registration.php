...
<html lang="en">
   <head>
      ...
      <title>Register Your NGO with VHD Mumbai - VHD Mumbai</title>
   ...
   <body>
      ...
      <section class="banner" id="community-inner-banner">
         ...
         <div class="caption-box">
            ...
            <h4 class="text-center">Register as an NGO</h4>
         </div>
      </section>
         ...
         <div class="container">
            <div class="community-section">
               <form class="form" action="" method="POST">
                  <p class="register-field-title pt-0">Is the NGO empaneled with BMC?</p>
                  <div class="d-flex type flex-wrap">
                     <div class="type-btn">
                        <input name="bmc_enlisted" type="radio" id="bmc_enlisted_yes" value="Yes">
                        <label for="bmc_enlisted_yes">Yes</label>
                     </div>
                     <div class="type-btn">
                        <input name="bmc_enlisted" type="radio" id="bmc_enlisted_no" value="No" checked>
                        <label for="bmc_enlisted_no">No</label>
                     </div>
                  </div>
                  <p class="register-field-title">Is your NGO registered?</p>
                  <div class="d-flex type flex-wrap pb-5">
                     <div class="type-btn">
                        <input name="ngo_registered" type="radio" id="ngo_registered_yes" value="Yes">
                        <label for="ngo_registered_yes">Yes</label>
                     </div>
                     <div class="type-btn">
                        <input name="ngo_registered" type="radio" id="ngo_registered_no" value="No" checked>
                        <label for="ngo_registered_no">No</label>
                     </div>
                  </div>
                  <div id="is_registered">
                     <p class="register-field-title pt-0">Select the type of registration</p>
                     <div class="d-flex checkbox-wrapp">
                        <div class="checkbox-btn mb-5">
                           <input name="is_welfare_board" type="checkbox" id="is_welfare_board" value="Animal Welfare Board">
                           <label for="is_welfare_board">Animal Welfare Board</label>
                        </div>
                        <div class="checkbox-btn mb-5">
                           <input name="is_charity" type="checkbox" id="is_charity" value="Charity Commissioner">
                           <label for="is_charity">Charity Commissioner</label>
                        </div>
                     </div>
                     <div class="d-flex">
                        <div class="col-md-6 text-field pb-5" id="board-registration">
                           <label for="animal_welfare_reg_no">Animal Welfare Board registration number</label>
                           <input placeholder="Enter registration no." type="text" name="animal_welfare_reg_no" id="animal_welfare_reg_no" min="0" minlength="1" maxlength="" autocomplete="on" value="">
                        </div>
                        <div class="col-md-6 text-field pb-5" id="charity-registration">
                           <label for="charity_reg_no">Charity Commissioner registration number</label>
                           <input placeholder="Enter registration no." type="text" name="charity_reg_no" id="charity_reg_no" min="0" minlength="1" maxlength="" autocomplete="on" value="">
                        </div>
                     </div>
                  </div>
                  <p class="register-field-title pt-0">Enter your NGOs details</p>
                  <div class="row">
                     <div class="col-md-4 text-field pb-5">
                        <label for="ngo_name">Name of the NGO<span>*</span></label>
                        <input placeholder="Enter NGO Name" type="text" name="ngo_name" id="ngo_name" min="0" minlength="1" maxlength="" autocomplete="on" value="" required>
                     </div>
                     <div class="col-md-4 text-field pb-5">
                  ...
                  <p class="register-field-title">Do you have an animal shelter?</p>
                  <div class="d-flex type flex-wrap pb-5">
                     <div class="type-btn">
                        <input name="shelter_available" type="radio" id="shelter_available_yes" value="Yes">
                        <label for="shelter_available_yes">Yes</label>
                     </div>
                     <div class="type-btn">
                        <input name="shelter_available" type="radio" id="shelter_available_no" value="No" checked>
                        <label for="shelter_available_no">No</label>
                     </div>
                  </div>
                  <div id="is_sheltered">
                     <div class="row">
                        <div class="col-md-12 extra-fields" id="shelter-wrapper">
                           <div class="accordion-wrapp mb-4" id="shelter-1">
                              <div href="#shelter-1" class="accordion-single">
                                 <p>Shelter - 1 </p>
                                 <div class="icons">
                              ...
                              <div id="shelter-1" class="collapse">
                                 <div class="row mt-5">
                                    <div class="col-md-12 text-field mb-4">
                                       <label for="shelter_pin_code_id-1">Pincode<span>*</span></label>
                                       <select id="shelter_pin_code_id-1" autocapitalize="none" autocomplete="off" autocorrect="off" name="shelter_pin_code_id-1" spellcheck="false" tabindex="0" aria-autocomplete="list" aria-expanded="false" aria-haspopup="true" role="combobox" value="" class="bg-white">
                                          <option hidden value="">Select pin code</option>
                                          <option>400029</option>
                                          <option>400065</option>
                                          <option>400011</option>
                                    ...
                                    <div class="col-md-12 text-field">
                                       <label for="shelter_address-1">Shelter’s Address<span>*</span></label>
                                       <div class="descrip-upload-wrapp col-md-12 bg-white">
                                          <textarea name="shelter_address-1" class="w-100" placeholder="Enter shelter’s address" id="shelter_address-1" cols="25" rows="5" required></textarea>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                           ...
                           <div class="add-more-btn mb-5">
                              ...
                              <p>Add more Shelter</p>
                           </div>
                        </div>
                     </div>
                  </div>
                  <p class="register-field-title pt-0">Enter the areas covered by your NGO during programs</p>
                  <div class="row" id="ngo-locations">
                     <div class="custom-checklist text-field pb-4 col-md-6">
                        <label for="location">Select Location<span>*</span></label>
                        <div class="dropdown ambulance_zone_id-1">
                           <input type="text" class="dropdown-btn" name="search_name_input" placeholder="Select Location / Areas" autocomplete="off">
                  ...
                  <div>
                  <p class="register-field-title">Types of animals nursed</p>
                  <div class="d-flex checkbox-wrapp">
                     <div class="checkbox-btn">
                        <input name="animal_id" type="checkbox" id="animal_type-1" value="Dogs">
                        <label for="animal_type-1">Dog</label>
                     </div>
                     <div class="checkbox-btn">
                        <input name="animal_id" type="checkbox" id="animal_type-2" value="Cats">
                  ...
                  <p class="register-field-title">Enter contact person’s details from the NGO <span class="required-field text-black d-inline-flex fst-normal">(Max 3)</span></p>
                  <div class="row">
                           ...
                           <div id="contact-1" class="collapse">
                              <div class="row mt-5">
                                 ...
                                 <div class="col-md-6 text-field">
                                    <label for="email-1">Official Email ID<span>*</span></label>
                                    <input placeholder="Enter Official Email ID" type="email" name="email-1" id="email-1" min="0" minlength="1" maxlength="" autocomplete="on" value="" required class="bg-white">
                                 </div>
                                 <div class="col-md-6 text-field">
                                    <label for="designation-1">Designation<span>*</span></label>
                                    <input placeholder="Enter Designation" type="text" name="designation-1" id="designation-1" min="0" minlength="1" maxlength="" autocomplete="on" value="" required class="bg-white">
                                 </div>
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4 text-field">
                        ...
                        <input placeholder="Enter Email ID" type="text" name="email" id="email" min="0" minlength="1" maxlength="" autocomplete="on" value="" required>
                     </div>
                  </div>
                  ...
                  <p class="register-field-title pt-5 pb-3">Enter your specialization details</p>
                  <div class="d-flex checkbox-wrapp flex-wrap">
                     <div class="checkbox-btn">
                        <input name="special_in_sterilization" type="checkbox" id="special_in_sterilization" value="Sterilization">
                        <label for="special_in_sterilization">Sterilization</label>
                     </div>
                     <div class="checkbox-btn">
                        <input name="special_in_vaccination" type="checkbox" id="special_in_vaccination" value="Vaccination">
                        <label for="special_in_vaccination">Vaccination</label>
                     </div>
                     <div class="checkbox-btn">
                        <input name="special_in_rescue" type="checkbox" id="special_in_rescue" value="Rescue & Rehabilitation">
                        <label for="special_in_rescue">Rescue & Rehabilitation</label>
                     </div>
                  </div>
                  <p class="register-field-title pt-5 pb-3">Are you interested in collaborating with other NGOs?</p>
      ...
      <script type="text/javascript">
         $(document).ready(function(){
            ...
            $('.add-more-btn').on('click', function() {
               ...
               if (wrapperId == 'contact-wrapper') {
                  ...
                  if (currentCount < maxContactAccordion) {
                     ...
                     .find('p').text('Contact Person - ' + newIndex);
               ...
               } else if (wrapperId == 'shelter-wrapper') {
                  ...
                  // Update the IDs and names for the cloned elements
                  newAccordion.find('.accordion-single').attr('href', '#shelter-' + newIndex)
                  .find('p').text('Shelter - ' + newIndex);
                  newAccordion.attr('id', 'shelter-wrapp-' + newIndex);
                  newAccordion.find('.collapse').attr('id', 'shelter-' + newIndex);
            ...
            $('#is_registered, #board-registration, #charity-registration, #is_sheltered, .selectedcount').hide();
            function toggleVisibility(inputSelector, targetSelector, valueToShow) {
               $(inputSelector).on('click', function() {
                  if (valueToShow !== undefined) {
                     $(targetSelector).toggle($(this).val() === valueToShow);
                  } else {
                     $(targetSelector).toggle($(this).prop('checked'));
                  }
               });
            }
            toggleVisibility('input[name="ngo_registered"]', '#is_registered', 'Yes');
            toggleVisibility('input#is_welfare_board', '#board-registration');
            toggleVisibility('input#is_charity', '#charity-registration');
            toggleVisibility('input[name="shelter_available"]', '#is_sheltered', 'Yes');

            // Toggle the dropdown content on button click
            $('#ngo-locations').on('click', '.custom-checklist .dropdown-btn', function() {
               $(this).siblings('.dropdown-content').toggle();
            });

            // Update button text based on the selected checkboxes
            $('#ngo-locations').on('change', '.custom-checklist .dropdown-content input[type="checkbox"]', function() {
               var selected = [];
               var selectedCount = 0;
